  ...
  const categoryPhotos = {
    ...
    bedrooms: {
      ...
      images: [
        ...
        '/upload/CL14.jpg',
        '/upload/CL15.jpg',
        '/upload/DSC_0408.webp',
        '/upload/DSC_0415.webp',
        '/upload/DSC_0427.webp',
        '/upload/DSC_0569.webp',
        '/upload/DSC_0570.webp',
        '/upload/DSC_0584.webp',
        '/upload/DSC_0596.webp',
        '/upload/DSC_0626.webp',
        '/upload/DSC_0634.webp',
        '/upload/IMG_6571.webp',
        '/upload/cityvilla16.png',
        '/upload/cityvilla17.png',
        '/upload/cityvilla18.png',
        '/upload/cityvilla20.png',
        '/upload/maple18_.png',
        '/upload/maple22.png',
        '/upload/maple23.png',
        '/upload/maple29.png',
        ...
        '/upload/maple33.png',
        '/upload/maple34.png',
        '/upload/viber_image_2026-05-15_16-14-51-595.jpg',
        '/upload/viber_image_2026-05-15_16-14-53-324.jpg'
      ]
    },
    dining: {
